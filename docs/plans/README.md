...
| 21    | completed | [Query performance baseline](PLAN-0021-query-performance-baseline.md)                             | Completed 2026-09-16; real API contract checks and 190 browser samples. [Evidence](../reviews/plan0021-query-baseline/readme.md). Optimization implementation is deferred.                                                                                        |
| 22    | completed | [Project query cache reuse](PLAN-0022-project-query-cache.md)                                     | Completed 2026-09-17; Project QueryManager sharing, list/detail/page/scroll restoration, Widget v1 + Dashboard v3 regressions and 10-pass real API evidence recorded. [Evidence](../reviews/plan0022-project-query-cache/readme.md).                              |
| 23    | completed | [Widget v1 and Dashboard v3 refactoring](PLAN-0023-widget-dashboard-api-refactoring.md)           | Completed 2026-09-17; Widget v1 configuration/data, Dashboard v3 placements/initialization, independent revisions, unplaced reuse/delete, responsive mocks and disposable real acceptance passed. [Evidence](../reviews/plan0023-widget-dashboard-api/readme.md). |
| 24    | completed | [Dashboard Widget interactions](PLAN-0024-dashboard-widget-interactions.md)                       | Completed 2026-09-17; Task Widget drag/drop and status PATCH, direct overview project rows, responsive Dashboard v3 and disposable Vite/Nginx acceptance passed. [Evidence](../reviews/plan0024-dashboard-widget-interactions/readme.md).                         |
| 25    | proposed  | [Journal Document Editor UI/UX](PLAN-0025-journal-document-editor.md) | Proposed 2026-09-22 for planning only; Journal Viewer navigation, shared BlockNote Editor/Viewer, autosave/publish and attachments with temporary Mock APIs. Implementation and real Backend integration are not approved. |

PLAN-0025 is registered as `proposed` for Plan creation only. It must not be activated or implemented before explicit user approval. Its first phase validates Frontend UI/UX with temporary Mock APIs; actual Backend integration is a separate follow-up with complete removal of the new Mock implementation.
