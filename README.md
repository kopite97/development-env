...
초기 프로젝트·운영·일지·마일스톤은 **예시 데이터**이며 일지는 직접 추가할 수 있습니다. 서비스 상태는 실제 모니터링 결과가 아닙니다. 서버·로그인·프로젝트 작성 기능은 구현하지 않았으며 여러 기기 동기화는 지원하지 않습니다. 링크 목록은 공식 문서 예시로, 사용자 링크 작성 기능은 후속 API 범위입니다. 크기는 1/2/3칸 너비 프리셋이며 자유 높이 조절은 제공하지 않습니다.
